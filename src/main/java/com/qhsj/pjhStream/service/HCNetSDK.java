...
public interface HCNetSDK extends StdCallLibrary {
    ...
    String path1=new File(path).getParentFile().getParentFile().getParentFile().getAbsolutePath();
    String path2=path1.split("file")[0]+"\\libs\\";
    HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary(path2+ "HCNetSDK",
            HCNetSDK.class);
    /***宏定义***/
    //常量
